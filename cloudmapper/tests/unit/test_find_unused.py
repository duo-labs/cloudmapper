...
from cloudmapper.shared import find_unused
...
class TestFindUnused(TestCase):
    ...
    def test_find_unused_elastic_ips_empty(self):
        ...
        with mock.patch("cloudmapper.shared.find_unused.query_aws") as mock_query:
            mock_query.side_effect = mocked_query_side_effect

            assert_equal(find_unused.find_unused_elastic_ips(self.mock_region), [])
    ...
    def test_find_unused_elastic_ips(self):
        ...
        with mock.patch("cloudmapper.shared.find_unused.query_aws") as mock_query:
            ...
            assert_equal(
                find_unused.find_unused_elastic_ips(self.mock_region),
    ...
    def test_find_unused_volumes(self):
        ...
        with mock.patch("cloudmapper.shared.find_unused.query_aws") as mock_query:
            ...
            assert_equal(find_unused.find_unused_volumes(self.mock_region), [{"id": "vol-2222"}])
    ...
    def test_find_unused_security_groups(self):
        ...
        with mock.patch("cloudmapper.shared.find_unused.query_aws") as mock_query:
            ...
            assert_equal(
                find_unused.find_unused_security_groups(self.mock_region),
                [
                    {
                        "description": "Public access",
                        "id": "sg-00000008",
    ...
    def test_find_unused_network_interfaces(self):
        ...
        with mock.patch("cloudmapper.shared.find_unused.query_aws") as mock_query:
            ...
            assert_equal(
                find_unused.find_unused_network_interfaces(self.mock_region),
                [{"id": "eni-00000001"}],
            )
    ...
    def test_unused_elastic_load_balancers(self):
        ...
        with mock.patch("cloudmapper.shared.find_unused.query_aws") as mock_query:
            ...
            assert_equal(
                find_unused.find_unused_elastic_load_balancers(self.mock_region),
                [{"LoadBalancerName": "some-elb"}],
            )
