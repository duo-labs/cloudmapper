...
from ..shared.common import parse_arguments, get_regions, setup_report_dir
...
def iam_report(accounts, config, args):
    ...
    # Read template
    with open(os.path.join(TEMPLATE_DIR, "iam_report.html"), "r") as report_template:
    ...
    with open(os.path.join(report_dir, "data.json"), "w") as outfile:
    ...
    report_output_file = os.path.join(report_dir, "iam_report.html")
