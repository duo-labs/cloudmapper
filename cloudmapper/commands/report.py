...
from cloudmapper import TEMPLATE_DIR
...
def report(accounts, config, args):
    ...
    report_output_file = os.path.join(report_dir, "report.html")

    # Read template
    with open(os.path.join(TEMPLATE_DIR, "report.html"), "r") as report_template:
