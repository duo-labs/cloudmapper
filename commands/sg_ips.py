...
def sg_ips(accounts):
    ...
    try:
        ...
        print("\n# Get city data")
        print("curl http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.tar.gz")
        print("tar -zxvf GeoLite2-City.tar.gz")
        print("mv GeoLite2-City_*/GeoLite2-City.mmdb .")
        print("\n# Get ASN data")
        print("curl http://geolite.maxmind.com/download/geoip/database/GeoLite2-ASN.tar.gz")
